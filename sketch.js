...
function setup(){
    ...
    weapon = Bodies.circle(50,200,20);
    World.add(world, weapon);

    launcher = new Launcher(this.weapon, {x: 135, y: 580});

    snake1 = new Snake(1320,590);
    snake2 = new Snake(1310,680);
...
function mouseDragged(){
 Matter.Body.setPosition(this.weapon, {x: mouseX , y: mouseY});
}
